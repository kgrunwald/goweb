...
// Package mock_ilog is a generated GoMock package.
package mock_ilog

import (
	gomock "github.com/golang/mock/gomock"
	ilog "github.com/kgrunwald/goweb/ilog"
	reflect "reflect"
)
...
func (m *MockLogger) WithField(key string, value interface{}) ilog.Logger {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithField", key, value)
	ret0, _ := ret[0].(ilog.Logger)
	return ret0
}
...
func (m *MockLogger) WithFields(values ...interface{}) ilog.Logger {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
...
func (mr *MockLoggerMockRecorder) WithFields(values ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithFields", reflect.TypeOf((*MockLogger)(nil).WithFields), values...)
}
